...
const DetailTab = () => {
  return (
    <div className="mt-5">
      ...
      <p className="text-body8 text-foundation-100">만 10세 ~ 만 16세</p>

      <p className="mt-5 text-body9 text-foundation-60">
        프로그램 모집 인원 수
      </p>
      <p className="text-body8 text-foundation-100">12명</p>
      ...
      <p className="text-body8 text-foundation-100">24.11.11 - 25.01.11</p>

      <div className="mt-5 flex w-full gap-2 rounded-l bg-orange-50 px-2 py-3 marker:items-center">
        <p className="text-body8 text-orange-400">
          매주 월, 수, 금<span className="px-2">|</span>
      ...
      <a
        href="https://www.sitelink1241.com/121342"
        target="_blank"
