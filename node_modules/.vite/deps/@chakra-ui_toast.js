...
import {
  newStyled
<<<<<<< Updated upstream
} from "./chunk-LV7WERP5.js";
=======
} from "./chunk-ZU2SKFJE.js";
>>>>>>> Stashed changes
import {
  Global,
  ThemeContext,
  ...
  keyframes
<<<<<<< Updated upstream
} from "./chunk-SSA4MY7S.js";
=======
} from "./chunk-RJFRPL7K.js";
>>>>>>> Stashed changes
import {
  require_react_dom
...
function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
  ...
  const processBatch = () => {
    ...
    runNextFrame2 = false;
    state3.delta = useDefaultElapsed2 ? 1e3 / 60 : Math.max(Math.min(timestamp - state3.timestamp, maxElapsed), 1);
    ...
    elementsToMeasure.forEach((element) => {
      ...
      if (restore) {
        restore.forEach(([key, value]) => {
          var _a7;
          (_a7 = element.getValue(key)) === null || _a7 === void 0 ? void 0 : _a7.set(value);
        });
      }
    });
...
function test(v) {
  var _a7, _b5;
  return isNaN(v) && typeof v === "string" && (((_a7 = v.match(floatRegex)) === null || _a7 === void 0 ? void 0 : _a7.length) || 0) + (((_b5 = v.match(colorRegex)) === null || _b5 === void 0 ? void 0 : _b5.length) || 0) > 0;
}
...
var DOMKeyframesResolver = class extends KeyframeResolver {
  ...
  measureEndState() {
    ...
    if ((_a7 = this.removedTransforms) === null || _a7 === void 0 ? void 0 : _a7.length) {
...
var MainThreadAnimation = class extends BaseAnimation {
  ...
  tick(timestamp, sample = false) {
    ...
    const state3 = isInDelayPhase ? { done: false, value: keyframes3[0] } : frameGenerator.next(elapsed);
    ...
    if (isAnimationFinished && finalKeyframe !== void 0) {
      state3.value = getFinalKeyframe(keyframes3, this.options, finalKeyframe);
    }
    if (onUpdate) {
  ...
  pause() {
    ...
    this.state = "paused";
    this.holdTime = (_a7 = this.currentTime) !== null && _a7 !== void 0 ? _a7 : 0;
  }
  complete() {
...
function memoSupports(callback, supportsFlag) {
  ...
  return () => {
    var _a7;
    return (_a7 = supportsFlags[supportsFlag]) !== null && _a7 !== void 0 ? _a7 : memoized();
  };
}
...
function pregenerateKeyframes(keyframes3, options) {
  ...
  let state3 = { done: false, value: keyframes3[0] };
  const pregeneratedKeyframes = [];
  let t2 = 0;
  while (!state3.done && t2 < maxDuration) {
...
var AcceleratedAnimation = class extends BaseAnimation {
  ...
  initPlayback(keyframes3, finalKeyframe) {
    ...
    if (!((_a7 = motionValue2.owner) === null || _a7 === void 0 ? void 0 : _a7.current)) {
      return false;
    }
...
function animateTarget(visualElement, targetAndTransition, { delay: delay2 = 0, transitionOverride, type } = {}) {
  ...
  for (const key in target) {
    const value = visualElement.getValue(key, (_a7 = visualElement.latestValues[key]) !== null && _a7 !== void 0 ? _a7 : null);
...
function animateVariant(visualElement, variant, options = {}) {
  var _a7;
  const resolved = resolveVariant(visualElement, variant, options.type === "exit" ? (_a7 = visualElement.presenceContext) === null || _a7 === void 0 ? void 0 : _a7.custom : void 0);
...
function createAnimationState(visualElement) {
  ...
  const buildResolvedTypeValues = (type) => (acc, definition) => {
    var _a7;
    const resolved = resolveVariant(visualElement, definition, type === "exit" ? (_a7 = visualElement.presenceContext) === null || _a7 === void 0 ? void 0 : _a7.custom : void 0);
    if (resolved) {
...
var AnimationFeature = class extends Feature {
  ...
  unmount() {
    ...
    (_a7 = this.unmountControls) === null || _a7 === void 0 ? void 0 : _a7.call(this);
  }
};
...
function usePresence() {
  ...
  (0, import_react5.useEffect)(() => register(id3), []);
  const safeToRemove = (0, import_react5.useCallback)(() => onExitComplete && onExitComplete(id3), [id3, onExitComplete]);
...
// node_modules/framer-motion/dist/es/motion/features/layout/MeasureLayout.mjs
var MeasureLayoutWithContext = class extends import_react8.Component {
  /**
...
function MeasureLayout(props) {
  ...
  const layoutGroup = (0, import_react8.useContext)(LayoutGroupContext);
  return (0, import_jsx_runtime.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react8.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
function createProjectionNode({ attachResizeListener, defaultParent, measureScroll, checkIsScrollRoot, resetTransform }) {
  return class ProjectionNode {
    ...
    measurePageBox() {
      ...
      const wasInScrollRoot = ((_a7 = this.scroll) === null || _a7 === void 0 ? void 0 : _a7.wasRoot) || this.path.some(checkNodeWasScrollRoot);
      if (!wasInScrollRoot) {
    ...
    removeElementScroll(box) {
      ...
      if ((_a7 = this.scroll) === null || _a7 === void 0 ? void 0 : _a7.wasRoot) {
    ...
    resolveTargetDelta(forceRecalculation = false) {
      ...
      const canSkip = !(forceRecalculation || isShared && this.isSharedProjectionDirty || this.isProjectionDirty || ((_a7 = this.parent) === null || _a7 === void 0 ? void 0 : _a7.isProjectionDirty) || this.attemptToResolveRelativeTarget || this.root.updateBlockedByResize);
      if (canSkip)
        return;
    ...
    scheduleRender(notifyAll = true) {
      var _a7;
      (_a7 = this.options.visualElement) === null || _a7 === void 0 ? void 0 : _a7.scheduleRender();
      if (notifyAll) {
        const stack = this.getStack();
...
function checkNodeWasScrollRoot(node) {
  var _a7;
  return node !== node.root && ((_a7 = node.scroll) === null || _a7 === void 0 ? void 0 : _a7.wasRoot);
}
...
function useVisualElement(Component3, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const wantsHandoff = (0, import_react13.useRef)(Boolean(optimisedAppearId) && !((_a7 = window.MotionHandoffIsComplete) === null || _a7 === void 0 ? void 0 : _a7.call(window, optimisedAppearId)) && ((_b5 = window.MotionHasOptimisedAnimation) === null || _b5 === void 0 ? void 0 : _b5.call(window, optimisedAppearId)));
  ...
  (0, import_react13.useEffect)(() => {
    ...
    if (wantsHandoff.current) {
      queueMicrotask(() => {
        var _a8;
        (_a8 = window.MotionHandoffMarkAsComplete) === null || _a8 === void 0 ? void 0 : _a8.call(window, optimisedAppearId);
      });
...
function createRendererMotionComponent({ preloadedFeatures, createVisualElement, useRender, useVisualState: useVisualState2, Component: Component3 }) {
  ...
  const ForwardRefMotionComponent = (0, import_react16.forwardRef)(MotionComponent);
...
function scrapeMotionValuesFromProps(props, prevProps, visualElement) {
  ...
  for (const key in style) {
    if (isMotionValue(style[key]) || prevProps.style && isMotionValue(prevProps.style[key]) || isForcedMotionValue(key, props) || ((_a7 = visualElement === null || visualElement === void 0 ? void 0 : visualElement.getValue(key)) === null || _a7 === void 0 ? void 0 : _a7.liveStyle) !== void 0) {
...
function buildHTMLStyles(state3, latestValues, transformTemplate2) {
  const { style, vars: vars2, transformOrigin } = state3;
...
function calcOrigin2(origin, offset, size2) {
...
var VisualElement = class {
  ...
  readValue(key, target) {
    var _a7;
    let value = this.latestValues[key] !== void 0 || !this.current ? this.latestValues[key] : (_a7 = this.getBaseTargetFromProps(this.props, key)) !== null && _a7 !== void 0 ? _a7 : this.readValueFromInstance(this.current, key, this.options);
  ...
  getBaseTarget(key) {
    ...
    if (typeof initial === "string" || typeof initial === "object") {
      const variant = resolveVariantFromProps(this.props, initial, (_a7 = this.presenceContext) === null || _a7 === void 0 ? void 0 : _a7.custom);
      if (variant) {
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  const size2 = (0, import_react23.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
  ...
  return (0, import_jsx_runtime3.jsx)(PopChildMeasure, { isPresent: isPresent2, childRef: ref, sizeRef: size2, children: React.cloneElement(children, { ref }) });
}
...
var PresenceChild = ({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode: mode2 }) => {
  ...
  const memoizedOnExitComplete = (0, import_react24.useCallback)((childId) => {
...
var AnimatePresence = ({ children, exitBeforeEnter, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode: mode2 = "sync" }) => {
  ...
  const presentChildren = (0, import_react26.useMemo)(() => onlyElements(children), [children]);
  const presentKeys = presentChildren.map(getChildKey);
  const isInitialRender = (0, import_react26.useRef)(true);
  const pendingPresentChildren = (0, import_react26.useRef)(presentChildren);
  const exitComplete = useConstant(() => /* @__PURE__ */ new Map());
  const [diffedChildren, setDiffedChildren] = (0, import_react26.useState)(presentChildren);
  const [renderedChildren, setRenderedChildren] = (0, import_react26.useState)(presentChildren);
  useIsomorphicLayoutEffect(() => {
  ...
  const { forceRender } = (0, import_react26.useContext)(LayoutGroupContext);
  return (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: renderedChildren.map((child) => {
    ...
    return (0, import_jsx_runtime5.jsx)(PresenceChild, { isPresent: isPresent2, initial: !isInitialRender.current || initial ? void 0 : false, custom: isPresent2 ? void 0 : custom, presenceAffectsLayout, mode: mode2, onExitComplete: isPresent2 ? void 0 : onExit, children: child }, key);
  }) });
};
...
function calcNextTime(current, next, prev, labels) {
  ...
  if (typeof next === "number") {
    ...
    return (_a7 = labels.get(next)) !== null && _a7 !== void 0 ? _a7 : current;
  }
}
    ...
    if (isMotionValue(subject)) {
      ...
      for (let subjectIndex = 0; subjectIndex < numSubjects; subjectIndex++) {
        ...
        for (const key in keyframes3) {
          resolveValueSequence(keyframes3[key], getValueTransition2(transition3, key), getValueSequence(key, subjectSequence), subjectIndex, numSubjects);
        }
      }
    }
...
function animateSequence(sequence, options, scope) {
  ...
  animationDefinitions.forEach(({ keyframes: keyframes3, transition: transition3 }, subject) => {
    animations2.push(...animateSubject(subject, keyframes3, transition3));
  });
  return animations2;
}
...
function hydrateKeyframes(valueName, keyframes3, read) {
  for (let i = 0; i < keyframes3.length; i++) {
    if (keyframes3[i] === null) {
      keyframes3[i] = i === 0 ? read() : keyframes3[i - 1];
    }
...
var NativeAnimation = class {
  constructor(element, valueName, valueKeyframes, options) {
    ...
    this.removeAnimation = () => {
      var _a7;
      return (_a7 = state.get(element)) === null || _a7 === void 0 ? void 0 : _a7.delete(valueName);
    };
    const onFinish = () => {
  ...
  get time() {
    var _a7;
    if (this.animation) {
      return millisecondsToSeconds(((_a7 = this.animation) === null || _a7 === void 0 ? void 0 : _a7.currentTime) || 0);
    }
    return 0;
  }
  set time(newTime) {
  ...
  flatten() {
    ...
    if (!this.animation)
      return;
    (_a7 = this.animation.effect) === null || _a7 === void 0 ? void 0 : _a7.updateTiming({ easing: "linear" });
  }
  play() {
    if (this.state === "finished") {
      this.updateFinishedPromise();
...
var createScopedWaapiAnimate = (scope) => {
  function scopedAnimate(elementOrSelector, keyframes3, options) {
    return new GroupPlaybackControls(animateElements(elementOrSelector, keyframes3, options, scope));
  }
  return scopedAnimate;
};
...
function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, layout: layout3 = true, ...props }, externalRef) {
  ...
  return (0, import_jsx_runtime11.jsx)(Component3, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style, x: point.x, y: point.y, zIndex }, layout: layout3, onDrag: (event, gesturePoint) => {
...
function useTheme() {
  const theme2 = (0, import_react52.useContext)(
    ThemeContext
  );
  if (!theme2) {
    throw Error(
...
var ColorModeContext = (0, import_react53.createContext)({});
ColorModeContext.displayName = "ColorModeContext";
function useColorMode() {
  const context = (0, import_react53.useContext)(ColorModeContext);
  if (context === void 0) {
...
var useSafeLayoutEffect = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react54.useLayoutEffect : import_react54.useEffect;
...
function ColorModeProvider(props) {
  ...
  const [colorMode, rawSetColorMode] = (0, import_react55.useState)(
    () => getTheme(colorModeManager, defaultColorMode)
  );
  const [resolvedColorMode, setResolvedColorMode] = (0, import_react55.useState)(
    () => getTheme(colorModeManager)
  );
  const { getSystemTheme, setClassName, setDataset, addListener } = (0, import_react55.useMemo)(
    () => getColorModeUtils({ preventTransition: disableTransitionOnChange }),
    [disableTransitionOnChange]
  );
  const resolvedValue = initialColorMode === "system" && !colorMode ? resolvedColorMode : colorMode;
  const setColorMode = (0, import_react55.useCallback)(
    (value2) => {
  ...
  return (0, import_jsx_runtime12.jsx)(ColorModeContext.Provider, { value: context, children });
}
...
function DarkMode(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(ColorModeContext.Provider, { value: context, ...props });
}
...
function subtract2(value) {
  ...
  if (!value)
    return value;
  value = (_a7 = px2(value)) != null ? _a7 : value;
  const OFFSET = -0.02;
...
function toMediaQueryString(min, max) {
  ...
  if (min)
    query.push("and", `(min-width: ${px2(min)})`);
  if (max)
    query.push("and", `(max-width: ${px2(max)})`);
  return query.join(" ");
}
...
var pseudoSelectors = {
   ...
   */
  _groupHover: toGroup(state2.hover),
  /**
   * Styles to apply when a sibling element with `.peer` or `data-peer` is hovered
   */
  _peerHover: toPeer(state2.hover),
  /**
   * Styles to apply when a parent element with `.group`, `data-group` or `role=group` is focused
   */
  _groupFocus: toGroup(state2.focus),
  /**
   * Styles to apply when a sibling element with `.peer` or `data-peer` is focused
   */
  _peerFocus: toPeer(state2.focus),
  /**
   * Styles to apply when a parent element with `.group`, `data-group` or `role=group` has visible focus
   */
  _groupFocusVisible: toGroup(state2.focusVisible),
  /**
   * Styles to apply when a sibling element with `.peer`or `data-peer` has visible focus
   */
  _peerFocusVisible: toPeer(state2.focusVisible),
  /**
   * Styles to apply when a parent element with `.group`, `data-group` or `role=group` is active
   */
  _groupActive: toGroup(state2.active),
  /**
   * Styles to apply when a sibling element with `.peer` or `data-peer` is active
   */
  _peerActive: toPeer(state2.active),
  /**
   * Styles to apply when a parent element with `.group`, `data-group` or `role=group` is disabled
   */
  _groupDisabled: toGroup(state2.disabled),
  /**
   *  Styles to apply when a sibling element with `.peer` or `data-peer` is disabled
   */
  _peerDisabled: toPeer(state2.disabled),
  /**
   *  Styles to apply when a parent element with `.group`, `data-group` or `role=group` is invalid
   */
  _groupInvalid: toGroup(state2.invalid),
  /**
   *  Styles to apply when a sibling element with `.peer` or `data-peer` is invalid
   */
  _peerInvalid: toPeer(state2.invalid),
  /**
   * Styles to apply when a parent element with `.group`, `data-group` or `role=group` is checked
   */
  _groupChecked: toGroup(state2.checked),
  /**
   * Styles to apply when a sibling element with `.peer` or `data-peer` is checked
   */
  _peerChecked: toPeer(state2.checked),
  /**
   *  Styles to apply when a parent element with `.group`, `data-group` or `role=group` has focus within
   */
  _groupFocusWithin: toGroup(state2.focusWithin),
  /**
   *  Styles to apply when a sibling element with `.peer` or `data-peer` has focus within
   */
  _peerFocusWithin: toPeer(state2.focusWithin),
  /**
   * Styles to apply when a sibling element with `.peer` or `data-peer` has placeholder shown
   */
  _peerPlaceholderShown: toPeer(state2.placeholderShown),
  /**
...
function rgba2(red, green, blue, alpha2) {
...
function useStyleConfigImpl(themeKey, props = {}) {
  ...
  const stylesRef = (0, import_react56.useRef)({});
  if (styleConfig) {
...
function styled(component, options) {
  ...
  const chakraComponent = import_react57.default.forwardRef(function ChakraComponent(props, ref) {
    const { colorMode, forced } = useColorMode();
    return import_react57.default.createElement(Component3, {
      ref,
...
function forwardRef4(component) {
  return (0, import_react58.forwardRef)(component);
}
...
function createContext10(options = {}) {
  const {
    strict = true,
    errorMessage = "useContext: `context` is undefined. Seems you forgot to wrap component within the Provider",
    name
  } = options;
  const Context = (0, import_react60.createContext)(void 0);
  Context.displayName = name;
  function useContext19() {
    var _a7;
    const context = (0, import_react60.useContext)(Context);
    if (!context && strict) {
      const error2 = new Error(errorMessage);
      error2.name = "ContextError";
      (_a7 = Error.captureStackTrace) == null ? void 0 : _a7.call(Error, error2, useContext19);
      throw error2;
    }
    return context;
  }
...
function ThemeProvider2(props) {
  ...
  const computedTheme = (0, import_react62.useMemo)(() => toCSSVar(theme2), [theme2]);
  return (0, import_jsx_runtime14.jsxs)(ThemeProvider, { theme: computedTheme, children: [
    (0, import_jsx_runtime14.jsx)(CSSVars, { root: cssVarsRoot }),
    children
  ] });
}
function CSSVars({ root = ":host, :root" }) {
  const selector = [root, `[data-theme]`].join(",");
  return (0, import_jsx_runtime14.jsx)(Global, { styles: (theme2) => ({ [selector]: theme2.__cssVars }) });
}
var [StylesProvider, useStyles] = createContext10({
  name: "StylesContext",
...
var ToastComponent = (0, import_react64.memo)((props) => {
  ...
  const toastStyle = (0, import_react64.useMemo)(() => getToastStyle(position2), [position2]);
...
var fallbackIcon = {
  path: (0, import_jsx_runtime16.jsxs)("g", { stroke: "currentColor", strokeWidth: "1.5", children: [
    ...
    (0, import_jsx_runtime16.jsx)("circle", { fill: "none", strokeMiterlimit: "10", cx: "12", cy: "12", r: "11.25" })
  ] }),
  viewBox: "0 0 24 24"
};
var Icon = forwardRef4((props, ref) => {
  ...
  if (element && typeof element !== "string") {
    return (0, import_jsx_runtime16.jsx)(chakra.svg, { as: element, ...shared, ...rest });
  }
  const _path = children != null ? children : fallbackIcon.path;
  return (0, import_jsx_runtime16.jsx)(chakra.svg, { verticalAlign: "middle", viewBox: _viewBox, ...shared, ...rest, children: _path });
});
...
function createContext11(options = {}) {
  ...
  const Context = (0, import_react66.createContext)(defaultValue);
  Context.displayName = name;
  function useContext19() {
    var _a7;
    const context = (0, import_react66.useContext)(Context);
    if (!context && strict) {
...
var [AlertProvider, useAlertContext] = createContext11({
  name: "AlertContext",
  hookName: "useAlertContext",
  providerName: "<Alert />"
});
var [AlertStylesProvider, useAlertStyles] = createContext11({
...
var Alert = forwardRef4(function Alert2(props, ref) {
  ...
  return (0, import_jsx_runtime23.jsx)(AlertProvider, { value: { status }, children: (0, import_jsx_runtime23.jsx)(AlertStylesProvider, { value: styles2, children: (0, import_jsx_runtime23.jsx)(
    chakra.div,
    {
      "data-status": status,
...
var [PortalManagerContextProvider, usePortalManager] = createContext11({
  strict: false,
  name: "PortalManagerContext"
});
function PortalManager(props) {
  const { children, zIndex } = props;
  return (0, import_jsx_runtime26.jsx)(PortalManagerContextProvider, { value: { zIndex }, children });
}
...
var [PortalContextProvider, usePortalContext] = createContext11({
  strict: false,
  name: "PortalContext"
});
var PORTAL_CLASSNAME = "chakra-portal";
var PORTAL_SELECTOR = `.chakra-portal`;
var Container = (props) => (0, import_jsx_runtime27.jsx)(
  "div",
  {
...
var DefaultPortal = (props) => {
  ...
  const _children = (manager == null ? void 0 : manager.zIndex) ? (0, import_jsx_runtime27.jsx)(Container, { zIndex: manager == null ? void 0 : manager.zIndex, children }) : children;
  return portal.current ? (0, import_react_dom.createPortal)(
    (0, import_jsx_runtime27.jsx)(PortalContextProvider, { value: portal.current, children: _children }),
    portal.current
...
var ContainerPortal = (props) => {
  ...
  if (host && portal) {
    return (0, import_react_dom.createPortal)(
      (0, import_jsx_runtime27.jsx)(PortalContextProvider, { value: appendToParentPortal ? portal : null, children }),
      portal
    );
  }
  return null;
...
function Portal(props) {
  ...
  return containerRef ? (0, import_jsx_runtime27.jsx)(ContainerPortal, { containerRef, ...rest }) : (0, import_jsx_runtime27.jsx)(DefaultPortal, { ...rest });
}
...
var [ToastOptionProvider, useToastOptionContext] = createContext11({
  name: `ToastOptionsContext`,
  strict: false
});
var ToastProvider = (props) => {
  const state3 = (0, import_react68.useSyncExternalStore)(
  ...
  const toastList = stateKeys.map((position2) => {
    ...
    return (0, import_jsx_runtime28.jsx)(
      "div",
      {
        ...
        children: (0, import_jsx_runtime28.jsx)(AnimatePresence, { initial: false, children: toasts.map((toast) => (0, import_jsx_runtime28.jsx)(
          Component3,
          {
            motionVariants,
            ...toast
  ...
  return (0, import_jsx_runtime28.jsx)(Portal, { ...portalProps, children: toastList });
};
...
function createStandaloneToast({
  ...
  const ToastContainer = () => (0, import_jsx_runtime29.jsx)(ThemeProvider2, { theme: theme2, children: (0, import_jsx_runtime29.jsx)(ColorModeContext.Provider, { value: colorModeContextValue, children: (0, import_jsx_runtime29.jsx)(
    ToastProvider,
    {
      defaultOptions,
      motionVariants,
